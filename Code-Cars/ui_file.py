...
def settingsMenu(screen, screen_size, bg_colour, a_colour, na_colour, cooldown, start_timer, g_size, s_length):
	...
	modes = {0:"Solo", 1:"Two Player", 2:"Race", 3:"Chase"}
	current_mode = 0
...
def endGame(mode, value):
	...
	if mode == 0:
		...
		screen.fill((0, 255, 0));
		# displayMessage("Game Complete!", BLACK, screen, 50, screen_size, screen_size[1]//4)
	...
	while carryOn:
		...
		if keys[pygame.K_RETURN] or keys[pygame.K_q] or keys[pygame.K_ESCAPE]:
			carryOn = False
			pygame.quit()
